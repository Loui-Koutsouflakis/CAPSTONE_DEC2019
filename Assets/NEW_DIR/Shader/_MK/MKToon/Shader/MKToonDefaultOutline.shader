Shader "Hidden/MK/Toon/Default Outline"
{
	Properties
	{
		...
		//Light
		[Enum(Default, Cel_Shade_Simple, Cel_Shade_Multi, Ramp)] _LightType ("Type", int) = 1
		[Enum(Unlit, Lambert, Phong, Blinn_Phong, Minneart, Oren_Nayer)] _LightModel ("Model", int) = 1
