...
public class SpikeRaiseLower : MonoBehaviour
{
    ...
    //k adjust this to be 1 lower then moles world space y pos
    [Range(-100.0f, 100.0f)]
    ...
    private float SpikeStart = 1; //1; // h
    private float SpikeRaiseFrequency = 53.9f; //53.9f; // b
    //private float SpikeWaveHieght = -1.0f; //-1.0f; // k
    private float SpikeTimer = 3;
    private float SpikeMoveSpeed = 27.4f; //27.4f;
