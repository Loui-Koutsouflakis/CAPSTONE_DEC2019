//edited - movement by Alek Tepylo Feb 18/19
...
public class Move : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //
        //accelPerSecond = maxSpeed / timeToMax;
        //
    }
    ...
    public void MoveTest()
    {
        ...
        //{
            ...
            transform.rotation = Quaternion.LookRotation(Vector3.RotateTowards(transform.forward, cammyFront, rotateSpeed * Time.fixedDeltaTime, 0.0f));
                //Vector3.RotateTowards(transform.forward, cammy.transform.forward, rotateSpeed * Time.fixedDeltaTime, 0.0f);
                //transform.forward = cammyFront;
            }
            ...
            {
                transform.rotation = Quaternion.LookRotation(Vector3.RotateTowards(transform.forward, cammyRight, rotateSpeed * Time.fixedDeltaTime, 0.0f));
                //transform.forward = cammyRight;
            }
            else if (Input.GetAxisRaw("Horizontal") < 0 && Input.GetAxisRaw("Vertical") == 0)
            {
                 transform.rotation = Quaternion.LookRotation(Vector3.RotateTowards(transform.forward, -cammyRight, rotateSpeed * Time.fixedDeltaTime, 0.0f));
            ...
            {
                transform.rotation = Quaternion.LookRotation(Vector3.RotateTowards(transform.forward, cammyFront + cammyRight, rotateSpeed * Time.fixedDeltaTime, 0.0f));
                //transform.forward = cammyFront + cammyRight;
            }
            else if (Input.GetAxisRaw("Vertical") > 0 && Input.GetAxisRaw("Horizontal") < 0)
            {
                transform.rotation = Quaternion.LookRotation(Vector3.RotateTowards(transform.forward, cammyFront - cammyRight, rotateSpeed * Time.fixedDeltaTime, 0.0f));
        ...
        if(horizontal != 0 || vertical != 0)
        {
            ...
            forwardVelocity = Mathf.Min(forwardVelocity, walkMax);           
        }
