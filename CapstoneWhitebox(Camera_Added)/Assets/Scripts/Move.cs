...
public class Move : MonoBehaviour
{
    ...
    public Transform bCamPivot;
    public Transform bRefPivot;
    public Transform bCamFollow;
    ...
    void CamUpdate()
    {
        ...
        if (switchCam == 1)
        {
            cammy.transform.position = Vector3.Slerp(cammy.transform.position, bCamFollow.transform.position, camLerpFactor);
            cammy.transform.rotation = Quaternion.Slerp(cammy.transform.rotation, bCamPivot.transform.rotation, camLerpFactor);
            bCamPivot.transform.eulerAngles = new Vector3(Mathf.Clamp(pitch, 0f, camPitchMax), yaw, 0f);
        }
    }
